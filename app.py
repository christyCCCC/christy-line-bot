...
四層結構：
第一層：製造好奇（問一個問題）
第二層：破壞預期（給一個超爛的答案讓對方傻眼）
第三層：情緒反轉（說「開玩笑的啦」讓對方等真正答案）
第四層：偷偷上價值（突然浪漫起來）
...
1. 愚公移山版：
   「你知道愚公為什麼要移山嗎？」
   （對方回答後）「錯 答案是移山移山亮晶晶✨」
   （對方傻眼後）「哈哈開玩笑的啦～愚公移山當然是為了我們下輩子的愛情沒阻礙」
...
6. 海浪版：
   「你知道海浪為什麼一直往岸上打嗎？」
   「因為它跟我一樣 明知道不一定有結果 還是會忍不住靠近」

7. 時鐘版：
   「你知道時鐘最厲害的地方是什麼嗎？」
   「它明明一直往前走 卻總能提醒人珍惜當下」
   「就像遇見你之後 我突然覺得時間變得很有價值」
